    ...
    <div>
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <Link
            to="/admin/articles"
            className="inline-flex size-9 items-center justify-center rounded-xl text-[var(--text-tertiary)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
          >
      ...
      <div className="space-y-4">
        ...
        <Card className="grid gap-4 p-5 sm:grid-cols-2">
          ...
          <Field label="封面图 URL">
            <Input value={coverImage} onChange={(e) => setCoverImage(e.target.value)} placeholder="https://…（可选）" />
          </Field>
        ...
        <Card className="overflow-hidden">
          <div className="flex items-center justify-between border-b border-[var(--border)] px-5 py-3">
            <span className="text-sm font-medium text-[var(--text-primary)]">正文（Markdown）</span>
            <div className="flex rounded-xl bg-[var(--bg-hover)] p-0.5">
              <button
                ...
                className={cn(
                  ...
                  !preview ? "bg-[var(--bg-card)] text-[var(--text-primary)] shadow-sm" : "text-[var(--text-tertiary)]",
                )}
              >
          ...
          {preview ? (
            <div className="min-h-96 px-6 py-5">
              {content.trim() ? (
                ...
                <p className="py-16 text-center text-sm text-[var(--text-tertiary)]">暂无内容</p>
              )}
            </div>
          ) : (
            <Textarea
              ...
              className="min-h-96 rounded-none border-0 bg-transparent focus:ring-0 px-5 py-4 font-mono text-sm leading-relaxed"
            />
          )}
        </Card>
      </div>
