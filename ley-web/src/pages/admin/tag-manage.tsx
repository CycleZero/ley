                ...
                <tr key={tag.id} className="transition-colors hover:bg-[var(--bg-hover)]/60">
                  <td className="px-6 py-3.5">
                    <span className="inline-flex items-center gap-2 font-medium text-[var(--text-primary)]">
                      <TagsIcon className="size-4 shrink-0 text-[var(--accent)]" />
                      #{tag.name}
                    </span>
                  </td>
                  <td className="hidden px-4 py-3.5 text-[var(--text-secondary)] md:table-cell">{tag.slug}</td>
                  <td className="px-4 py-3.5 text-[var(--text-secondary)]">{tag.article_count}</td>
                  <td className="px-6 py-3.5">
