                ...
                <tr key={c.id} className="transition-colors hover:bg-[var(--bg-hover)]/60">
                  <td className="px-6 py-3.5">
                    <span className="inline-flex items-center gap-2 font-medium text-[var(--text-primary)]">
                      ...
                      {c.name}
                      {c.children.length > 0 && (
                        <Badge className="font-mono tabular-nums">{c.children.length} 个子类</Badge>
                      )}
                    </span>
                    {c.description && (
                  ...
                  <td className="hidden px-4 py-3.5 font-mono tabular-nums text-[var(--text-secondary)] sm:table-cell">
                    {c.sort_order}
                  </td>
