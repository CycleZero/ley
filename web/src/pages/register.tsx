  ...
  return (
    <div>
      <div className="mb-8 text-center">
        <h2 className="text-xl font-bold text-[var(--ink)]">创建账号</h2>
        <p className="mt-1 text-sm text-[var(--ink-2)]">开始你的博客之旅</p>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between text-sm">
        <Link to="/" className="text-[var(--ink-3)] hover:text-[var(--ink)] transition-colors">
          返回首页
        </Link>
        <Link to="/login" state={{ from: redirect }} className="text-[var(--accent-blue)] hover:underline">
          已有账号？登录
        </Link>
      </div>
    </div>
